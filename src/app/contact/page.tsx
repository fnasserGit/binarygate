    ...
    <div className="min-h-screen bg-[#f5f5f2] text-neutral-900">
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-black/10 bg-[#f5f5f2]/90 backdrop-blur-lg">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 md:px-6">
          ...
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-neutral-600 transition hover:text-neutral-900"><ArrowLeft className="h-4 w-4" /> Back</Link>
        </div>
      </header>
      ...
      <footer className="border-t border-neutral-200/70 px-4 py-8 md:px-6 md:py-10">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-4 text-xs md:text-sm text-neutral-500 md:flex-row">
          ...
          <div className="flex gap-6"><Link href="/" className="transition hover:text-neutral-900">Home</Link></div>
        </div>
      </footer>
    </div>
  );

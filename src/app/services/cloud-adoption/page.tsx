...
export const metadata = {
  title: "Cloud Adoption | BinaryGate",
  description: "Migrations, Hybrid, Foundations.",
};
      ...
      <section className="bg-white">
        <div className="mx-auto w-full max-w-[1200px] px-6 py-16 sm:px-8 lg:px-10 lg:py-20">
          ...
          <p className="mt-4 text-sm text-neutral-600 sm:text-base">
            This service detail page is coming soon. Reach out to learn how we can help with cloud adoption.
          </p>
        </div>
      </section>
    </main>

...
const FOOTER_LINKS = {
  ...
  section2: {
    ...
    links: [
      ...
      { label: "Hybrid & On-Prem", href: "/services/hybrid-on-prem" },
      { label: "Cybersecurity", href: "/services/network-security-engineering" },
      { label: "Managed Services", href: "/services/managed-cloud-operations" },
      { label: "Software Development", href: "/services/software-development" },
    ],
  },
  company: [
    { label: "About", href: "/about" },
    { label: "Approach", href: "/approach/assess" },
  ...
  contact: {
    ...
    ctaHref: "/services/cloud#lets-talk",

...
function getApproachStageHref(slug: string) {
  return `/what-we-do/strategy-to-execution#${slug}`;
}
                ...
                <div key={stage.phase} className="space-y-6">
                  <div {...getCardAnim(index)}>
                    <ServiceCard
                      ...
                      href={getApproachStageHref(stage.slug)}
                      eyebrow={stage.phase}
              ...
              <div className="grid grid-cols-[minmax(0,1.2fr)_auto_minmax(0,1.2fr)] items-stretch gap-6">
                <div {...getCardAnim(0)} className="h-full">
                  <ServiceCard
                    ...
                    href={getApproachStageHref(approachStages[0].slug)}
                ...
                <div {...getCardAnim(1)} className="h-full">
                  <ServiceCard
                    ...
                    href={getApproachStageHref(approachStages[1].slug)}
              ...
              <div className="mt-6 grid grid-cols-[minmax(0,1.2fr)_auto_minmax(0,1.2fr)] items-stretch gap-6">
                <div {...getCardAnim(2)} className="h-full">
                  <ServiceCard
                    ...
                    href={getApproachStageHref(approachStages[2].slug)}
                ...
                <div {...getCardAnim(3)} className="h-full">
                  <ServiceCard
                    ...
                    href={getApproachStageHref(approachStages[3].slug)}
